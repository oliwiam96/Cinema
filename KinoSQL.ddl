...
CREATE TABLE bilet (
    ...
    miejscenaseansie_rz¹d           CHAR(2) NOT NULL,
...
ALTER TABLE miejsce
    ADD CONSTRAINT miejsce_pk PRIMARY KEY ( rz¹d,
    nr_miejsca,
    sala_nr_sali );
...
ALTER TABLE miejscenaseansie
    ADD CONSTRAINT miejscenaseansie_miejsce_fk FOREIGN KEY ( miejsce_rz¹d,
    miejsce_nr_miejsca,
    miejsce_sala_nr_sali )
        REFERENCES miejsce ( rz¹d,
        nr_miejsca,
        sala_nr_sali );
